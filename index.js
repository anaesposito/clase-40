...
let respuestaUsuario = prompt(
  "Hola! Por favor elegi la dificultad del juego, facil, mediano o dificil"
);

const validarRespuestUsuario = () => {
  if (respuestaUsuario == "facil") {
    return crearGrilla(4, 4);
  }
  if (respuestaUsuario == "mediano") {
    return crearGrilla(6, 6);
  }
  if (respuestaUsuario == "dificil") {
    return crearGrilla(9, 9);
  }
};

validarRespuestUsuario();
